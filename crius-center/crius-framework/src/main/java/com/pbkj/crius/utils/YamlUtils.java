...
public class YamlUtils {
    ...
    static Resource[] ymlResources = {new ClassPathResource("application-dev.yml")};
     ...
     * @throws IOException
     */
    public static Map<String, Object> yamlHandler() throws IOException {
        //返回的结果
